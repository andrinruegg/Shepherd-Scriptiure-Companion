...
const Navigation: React.FC<NavigationProps> = ({ currentBookId, currentChapter, onNavigate, language, readChapters = {} }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        <Book size={18} className="text-indigo-600 dark:text-indigo-400 shrink-0" />
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="p-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex items-center justify-between shrink-0 pt-[env(safe-area-inset-top,1rem)]">
                ...
                <div className="p-3 bg-white dark:bg-slate-900 shrink-0">
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-4 py-3 text-base md:text-sm bg-slate-100 dark:bg-slate-800 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 dark:text-white transition-all border border-transparent focus:bg-white dark:focus:bg-slate-850"
                      value={searchQuery}
              ...
              `}>
                <div className="p-4 border-b border-slate-100 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm shrink-0 flex items-center justify-between shadow-sm z-10">
                  <button 
                    ...
                    className="md:hidden p-2 -ml-2 text-slate-500 hover:text-indigo-600 dark:text-slate-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition-colors"
                  >
                    <ArrowLeft size={20} />
                  </button>
