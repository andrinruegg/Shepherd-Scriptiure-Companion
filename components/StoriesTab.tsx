              ...
              <div className="w-full max-w-4xl bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl border border-white dark:border-slate-800 overflow-hidden flex flex-col md:flex-row h-fit md:h-[600px] mt-4 mb-10">
                  <div className="w-full md:w-[45%] relative h-64 md:h-full shrink-0">
                      ...
                      <div className="absolute bottom-8 left-8 right-8 text-white hidden md:block">
                         <div className={`px-3 py-1 mb-3 rounded-full bg-gradient-to-r ${getPersonaTheme(selectedPersona.id).gradient} text-[10px] font-black uppercase tracking-[0.3em] w-fit shadow-xl`}>Biografie</div>
                      ...
                      <div className="flex-1 overflow-y-auto mb-8 pr-2 no-scrollbar border-l-2 border-slate-50 dark:border-slate-800 pl-6">
                        <div className="space-y-6">
                            ...
                            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-dashed border-slate-200 dark:border-slate-700 text-center">
                               <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Tipp: Frag ihn nach seinen Erlebnissen!</p>
                            </div>
                        </div>
                      </div>
