...
const HomeView: React.FC<HomeViewProps> = ({ 
    ...
    return (
        <div className="flex flex-col h-full overflow-y-auto bg-transparent transition-colors">
            {/* Soft Ambient Blobs for Home View - Brand Palette */}
            <div className="fixed top-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#d2b48c]/20 blur-[120px] rounded-full pointer-events-none z-0 dark:hidden"></div>
            <div className="fixed bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#7c4a32]/10 blur-[120px] rounded-full pointer-events-none z-0 dark:hidden"></div>
            ...
            <header className="px-4 md:px-6 py-4 md:py-5 flex items-center justify-between glass-header sticky top-0 z-50 bg-white/60 dark:bg-slate-950/70 backdrop-blur-2xl border-b border-white/50 dark:border-white/5 pt-safe">
                <div className="flex items-center gap-3">
                    <div className="bg-gradient-to-br from-[#7c4a32] to-[#54362d] p-2 rounded-xl shadow-lg shadow-[#7c4a32]/20 transform hover:scale-105 transition-transform">
                    ...
                    <div>
                        ...
                        {dailyStreak > 0 && (
                            <div className="flex items-center gap-1 text-[9px] md:text-[10px] font-black text-amber-600 dark:text-amber-500 mt-1 uppercase tracking-wider">
                ...
                <div className="flex items-center gap-1 md:gap-2">
                    ...
                    <button onClick={onOpenNotifications} className="p-2 md:p-2.5 rounded-full hover:bg-white/80 dark:hover:bg-white/10 text-slate-500 dark:text-slate-400 transition-all relative" title={t('sidebar.tooltips.inbox')}>
                        <Bell size={20} />
                        {notificationCount > 0 && <span className="absolute top-2 right-2 w-2.5 h-2.5 bg-rose-600 rounded-full border-2 border-white dark:border-slate-900 shadow-sm"></span>}
                    </button>
            ...
            <div className="flex-1 p-6 md:p-10 max-w-6xl mx-auto w-full pb-28 relative z-10">
                <div className="mb-8 md:mb-12 animate-fade-in mt-2">
                    <h1 className="text-3xl md:text-6xl font-serif-text font-bold text-slate-900 dark:text-white mb-3 md:mb-4 tracking-tight">
                        {greeting}, <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7c4a32] via-[#d2b48c] to-[#54362d]">{displayName || 'Friend'}</span>
                    </h1>
                ...
                >
                    ...
                    <div className="relative p-8 md:p-14 z-10">
                        ...
                        <h3 className="text-xl md:text-4xl font-serif-text leading-snug font-medium mb-8 md:mb-10 max-w-4xl text-slate-800 dark:text-[#f5f1e8] italic line-clamp-4 md:line-clamp-none">
                            "{dailyVerse.text}"
                        </h3>
