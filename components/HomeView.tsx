            ...
            <div className="flex-1 p-6 max-w-5xl mx-auto w-full pb-24">
                ...
                >
                    ...
                    <div className="relative p-8 md:p-10 z-10">
                        ...
                        <h3 className="text-xl md:text-2xl font-serif-text leading-relaxed font-medium mb-6 max-w-3xl text-slate-800 dark:text-emerald-50 italic">
                            "{dailyVerse.text}"
                        </h3>
                        <div className="flex items-center justify-between pt-4 border-t border-emerald-100 dark:border-white/10">
                            ...
                            <div className="bg-emerald-600 dark:bg-white text-white dark:text-slate-900 w-8 h-8 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                <ArrowRight size={16} />
                            </div>
                        </div>
                    </div>
                    ...
                    {SECONDARY_GRID.map((feature: any) => (
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-slate-500 dark:text-slate-400 font-medium opacity-80 mt-1 line-clamp-2">{feature.sub}</p>
                            </div>
                        </button>
                    ))}
                </div>
